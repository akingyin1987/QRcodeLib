...
import com.akingyin.qrcodelib.exception.QRGenerationException;
import com.akingyin.qrcodelib.image.ImageType;
import com.akingyin.qrcodelib.scheme.VCard;
...
public class QRCode extends AbstractQRCode {
     ...
     * Size override is done by calling {@link AbstractQRCode#} e.g.
     ...
     *
     *
     * @param imageType the you would like the resulting QR to be
